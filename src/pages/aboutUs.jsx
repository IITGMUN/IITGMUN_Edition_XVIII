...
const AboutUs = () => {
  ...
  return (
    <div className="w-full font-montserrat overflow-x-hidden">
      ...
      {/* 1. TOP WHITE SECTION (Logo Only) */}
      <div className="w-full bg-[#F3F8F9] py-32 flex flex-col justify-center items-center gap-6">
        <div className="w-40 md:w-56 h-auto">
          <img
            src={topLogo}
            alt="UN Logo"
      ...
      {/* 2. BLUE SECTION: Intro Text */}
      <div className="w-full bg-gradient-to-b from-[#4b56d2] to-[#4b56d2] text-white py-20 flex justify-center">
        <p className="max-w-6xl w-full text-sm md:text-base lg:text-lg leading-loose font-light text-justify px-6">
      ...
      {/* 3. RED SECTION: About IITGMUN Edition XI */}
      <div className="w-full bg-[#EE3C66] text-white py-20 px-6 md:px-20 flex flex-col md:flex-row items-center justify-center gap-16">
        <div className="md:w-3/5">
          <h2 className="text-3xl md:text-5xl font-extrabold mb-6 text-center md:text-left">
            About IITGMUN Edition XI
          </h2>
        ...
        {/* Logo Section */}
        <div className="md:w-2/5 flex justify-center md:justify-start px-20">
